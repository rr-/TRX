...
- http://lostartefacts.dev/aux/tr2x/main.zip (main assets)
- http://lostartefacts.dev/aux/tr2x/music.zip (music files)
- http://lostartefacts.dev/aux/tr2x/trgm.zip (TR: The Golden Mask expansion pack)
