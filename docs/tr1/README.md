...
- http://lostartefacts.dev/aux/tr1x/main.zip (main assets)
- http://lostartefacts.dev/aux/tr1x/music.zip (music files)
- http://lostartefacts.dev/aux/tr1x/trub-music.zip (TR: Unfinished Business expansion pack with fan-patched music)
- http://lostartefacts.dev/aux/tr1x/trub-vanilla.zip (TR: Unfinished Business expansion pack in its original form)
