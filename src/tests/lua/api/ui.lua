...
test("a model in a slot draws where it was moved", function()
  ...
  assert(
    slot_line(fake.render(0))
      == "mesh_slot obj=5 x=10.0 y=20.0 w=30.0 h=40.0 rot_x=0 rot_y=512 rot_z=0"
  )
  slot:release()
end)
...
test("a model in a slot is blended between its two ticks", function()
  ...
  assert(
    slot_line(fake.render(0.5))
      == "mesh_slot obj=5 x=50.0 y=20.0 w=10.0 h=10.0 rot_x=0 rot_y=500 rot_z=0"
  )
...
test("a model put down for the first time does not travel to it", function()
  ...
  assert(
    slot_line(fake.render(0.5))
      == "mesh_slot obj=5 x=80.0 y=0.0 w=10.0 h=10.0 rot_x=0 rot_y=0 rot_z=0"
  )
  slot:release()
end)
...
test("a released slot's handle does not reach the next taker", function()
  ...
  assert(
    slot_line(fake.render(0))
      == "mesh_slot obj=5 x=1.0 y=2.0 w=3.0 h=4.0 rot_x=0 rot_y=0 rot_z=0"
  )
  second:release()
end)
