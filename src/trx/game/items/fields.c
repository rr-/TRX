...
// Mechanism only. This table says how to reach each ITEM member; it does not
// decide what is public, what it is called, or what it means. That is declared
// in data/scripting/items.lua, and only members named there become reachable
// from a script.
//
// Consequently: no descriptions here, and adding a line here does not widen the
// public API.

// --- accessors for members that are computed, validated, or side-effecting ---
