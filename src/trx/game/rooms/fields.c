...
// Mechanism only. This table says how to reach each ROOM member; what is
// public, what it is called and what it means is declared in
// data/scripting/rooms.lua.
//
// ROOM.flags is a nested struct of plain bools rather than a bitfield, so
// offsetof reaches straight through it.
