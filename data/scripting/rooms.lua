...
api.type("rooms.Room", {
  ...
  fields = {
    ...
    flip_status = {
      ...
      type = "integer",
      writable = false,
      description = "Current flip status. Compare against `trx.rooms.fn.FlipStatus`.",
    },
  ...
  params = {
    {
      name = "effect_id",
      type = "integer",
      description = "0-based effect id. Use `-1` to clear the current effect. Compare against "
...
-- Retained for compatibility: existing scripts reach for trx.rooms.fn.
rawset(trx.rooms, "fn", {
